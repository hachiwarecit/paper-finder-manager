...
> **別プロジェクト同居のお知らせ**
> このリポジトリには、応用情報技術者試験の用語ドリル（`scripts/extract.py`,
> `scripts/build_quiz.py`, `dist/index.html`）も入っている。文献管理システムとは
> 独立していて、依存関係もない。→ [README-ap-term-drill.md](README-ap-term-drill.md)
