...
COLUMNS = [
    ...
    "is_multi_country_study", "country_data_separable",
    "country_specific_analysis_available", "country_inclusion_evidence",
...
CAND_COLUMNS = [
    ...
    "abstract", "source_name", "source_url", "pdf_url", "publisher_url",
    "repository_url", "oa_url", "landing_page_url", "manual_pdf_search_url",
    ...
    "legality_note", "candidate_score", "manual_priority", "candidate_status",
    "duplicate_status", "duplicate_of", "same_dataset_warning", "notes",
    "auto_approve_reason", "auto_approve_blockers", "download_status",
    "download_error", "attempted_url", "downloaded_path", "download_timestamp",
...
class PaperDB:
    ...
    def _from_row(row: sqlite3.Row) -> PaperRecord:
        ...
        return PaperRecord(
            ...
            is_multi_country_study=as_bool("is_multi_country_study"),
            country_data_separable=as_bool("country_data_separable"),
            country_specific_analysis_available=as_bool("country_specific_analysis_available"),
            country_inclusion_evidence=d.get("country_inclusion_evidence") or "",
    ...
    def _cand_from_row(row: sqlite3.Row) -> Candidate:
        ...
        return Candidate(
            ...
            source_url=d.get("source_url") or None,
            pdf_url=d.get("pdf_url") or None,
            publisher_url=d.get("publisher_url") or "",
            repository_url=d.get("repository_url") or "",
            oa_url=d.get("oa_url") or "",
            landing_page_url=d.get("landing_page_url") or "",
            manual_pdf_search_url=d.get("manual_pdf_search_url") or "",
            country=d.get("country") or "unknown",
            query_country=d.get("query_country") or "unknown",
            category=d.get("category") or "unknown",
            target_country=d.get("target_country") or "unknown",
            ...
            manual_priority=d.get("manual_priority") or "",
